...
@Component
public class UnsupportedRouterGatewayFilterFactory extends AbstractGatewayFilterFactory<Config> {

    // Routes to second host when it has 2 hosts to route towards.
    public UnsupportedRouterGatewayFilterFactory() {
        super(Config.class);
    }
