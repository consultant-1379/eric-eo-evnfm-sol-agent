...
public class PostChangePackageInfoVnfPositiveBase {
    ...
    @BeforeEach
    public void setUp() {
        given(lifeCycleManagementService.changePackageInfo(anyString(), any(ChangeFlavourVnfRequest.class)))
                .willReturn("ded2e84a-521b-11ea-ae59-b61d40103d36");
