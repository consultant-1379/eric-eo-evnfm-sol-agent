...
public class GetInstancePositiveBase {
    ...
    @BeforeEach
    public void setUp() {
        given(vnfInstanceService.getAllVnfs())
                .willReturn(VnfInstanceResponseMockData.getVnfInstancesResponses());
        given(vnfInstanceService.getSampleVnf())
                .willReturn(VnfInstanceResponseMockData.getSampleVnf());
